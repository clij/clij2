...
* CLIJ2_setRampX(Image source, Number value)
* CLIJ2_setRampY(Image source, Number value)
* CLIJ2_setRampZ(Image source, Number value)
...
* CLIJx_equalizeMeanIntensitiesOfSlices(Image input, Image destination, Number referenceSlice)
* CLIJx_excludeLabelsSubSurface(Image pointlist, Image label_map_input, Image label_map_destination, Number centerX, Number centerY, Number centerZ)
...
* CLIJx_matrixEqual(Image input1, Image input2, Number tolerance)
...
* CLIJx_powerImages(Image input, Image exponent, Image destination)
