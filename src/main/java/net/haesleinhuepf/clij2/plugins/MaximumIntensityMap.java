...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_maximumIntensityMap")
public class MaximumIntensityMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public static boolean maximumIntensityMap(CLIJ2 clij2, ClearCLBuffer intensity_image, ClearCLBuffer label_map, ClearCLBuffer result) {
    ...
    public String getDescription() {
        return "Takes an image and a corresponding label map, determines the maximum intensity per label and replaces every label with the that number.\n\nThis results in a parametric image expressing mean object intensity.";
    }
