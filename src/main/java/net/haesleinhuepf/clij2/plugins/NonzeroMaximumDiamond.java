...
public class NonzeroMaximumDiamond extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        ...
        boolean result = getCLIJ2().nonzeroMaximumDiamond(input, flag, output);
        flag.close();
        return result;
    }
    ...
    public String getDescription() {
        return "Apply a maximum filter (diamond shape) to the input image. \n\nThe radius is fixed to 1 and pixels with value 0 are ignored.\n" +
