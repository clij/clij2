...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_standardDeviationIntensityMap")
public class StandardDeviationIntensityMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    @Deprecated
    public static boolean labelStandardDeviationIntensityMap(CLIJ2 clij2, ClearCLBuffer intensity_image, ClearCLBuffer label_map, ClearCLBuffer result) {
        return standardDeviationIntensityMap(clij2, intensity_image, label_map, result);
    }

    public static boolean standardDeviationIntensityMap(CLIJ2 clij2, ClearCLBuffer intensity_image, ClearCLBuffer label_map, ClearCLBuffer result) {
