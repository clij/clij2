...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_maximumTouchingNeighborDistanceMap")
public class MaximumTouchingNeighborDistanceMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public static boolean maximumTouchingNeighborDistanceMap(CLIJ2 clij2, ClearCLBuffer pushed, ClearCLBuffer result) {
        ...
        MaximumDistanceOfTouchingNeighbors.maximumDistanceOfTouchingNeighbors(clij2, distance_matrix, touch_matrix, distance_vector);
        touch_matrix.close();
    ...
    public String getDescription() {
        return "Takes a label map, determines which labels touch and replaces every label with the maximum distance to their neighboring labels.\n\n" +
