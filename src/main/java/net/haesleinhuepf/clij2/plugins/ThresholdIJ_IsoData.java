 ...
 *         February 2020
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_thresholdIJ_IsoData")
// This is generated code. See net.haesleinhuepf.clijx.codegenerator.GenerateThresholdOperations for details
public class ThresholdIJ_IsoData extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, HasAuthor, HasLicense, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        ...
        return thresholdIJ_IsoData(getCLIJ2(), src, dst);
    }

    public static boolean thresholdIJ_IsoData(CLIJ2 clij2, ClearCLBuffer src, ClearCLBuffer dst) {
        return clij2.automaticThreshold(src, dst, "IJ_IsoData");
    }

    @Override
    public String getDescription() {
        StringBuilder doc = new StringBuilder();
        doc.append("The automatic thresholder utilizes the IJ_IsoData threshold method implemented in ImageJ using a histogram determined on \n" +
