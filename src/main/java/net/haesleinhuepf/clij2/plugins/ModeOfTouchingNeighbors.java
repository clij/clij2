...
public class ModeOfTouchingNeighbors extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public String getParameterHelpText() {
        return "Image values, Image touch_matrix, ByRef Image mode_values_destination";
    }

    @Override
    public boolean executeCL() {
        boolean result = modeOfTouchingNeighbors(getCLIJ2(), (ClearCLBuffer) (args[0]), (ClearCLBuffer) (args[1]),  (ClearCLBuffer) (args[2]));
        return result;
    }

    public static boolean modeOfTouchingNeighbors(CLIJ2 clij2, ClearCLBuffer src_values, ClearCLBuffer touch_matrix, ClearCLBuffer dst_values) {
        ...
        clij2.execute(ModeOfTouchingNeighbors.class, "mode_of_touching_neighbors_x.cl", "mode_of_touching_neighbors", globalSizes, globalSizes, parameters);
