...
public class ResliceBottom extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        return getCLIJ2().resliceBottom((ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]));
    }
