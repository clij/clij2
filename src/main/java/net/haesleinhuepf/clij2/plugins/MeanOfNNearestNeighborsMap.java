 ...
 * January 2021
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_meanOfNNearestNeighborsMap")
public class MeanOfNNearestNeighborsMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        boolean result = meanOfNNearestNeighborsMap(getCLIJ2(), (ClearCLBuffer) (args[0]), (ClearCLBuffer) (args[1]),  (ClearCLBuffer) (args[2]), asInteger(args[3]));
        return result;
    }

    public static boolean meanOfNNearestNeighborsMap(CLIJ2 clij2, ClearCLBuffer parametric_map, ClearCLBuffer label_map, ClearCLBuffer parametric_map_destination, Integer n) {
