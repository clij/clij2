...
public class DilateBoxSliceBySlice extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public static boolean dilateBoxSliceBySlice(CLIJ2 clij2, ClearCLImageInterface src, ClearCLImageInterface dst) {
        ...
        clij2.execute(DilateBoxSliceBySlice.class, "dilate_box_slice_by_slice_3d_x.cl", "dilate_box_slice_by_slice_3d", dst.getDimensions(), dst.getDimensions(), parameters);
        return true;
    }
