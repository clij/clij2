...
public class Flip2D extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public boolean executeCL() {
        ...
        return flip(getCLIJ2(), (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), flipX, flipY);
    }
