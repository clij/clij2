...
public class TransposeYZ extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public static boolean transposeYZ(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer output) {
        ...
        clij2.execute(TransposeXY.class, "transpose_yz_" + input.getDimension() + "d_x.cl", "transpose_yz_" + input.getDimension() + "d", output.getDimensions(), output.getDimensions(), parameters);
        return true;
    }
