...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_pushCurrentSlice")
public class PushCurrentSlice extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
