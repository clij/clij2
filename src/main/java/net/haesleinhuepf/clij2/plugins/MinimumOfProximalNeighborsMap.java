 ...
 * January 2021
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_minimumOfProximalNeighborsMap")
public class MinimumOfProximalNeighborsMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        boolean result = minimumOfProximalNeighborsMap(getCLIJ2(), (ClearCLBuffer) (args[0]), (ClearCLBuffer) (args[1]),  (ClearCLBuffer) (args[2]), asFloat(args[3]), asFloat(args[4]));
        return result;
    }

    public static boolean minimumOfProximalNeighborsMap(CLIJ2 clij2, ClearCLBuffer parametric_map, ClearCLBuffer label_map, ClearCLBuffer parametric_map_destination, Float min_distance, Float max_distance) {
