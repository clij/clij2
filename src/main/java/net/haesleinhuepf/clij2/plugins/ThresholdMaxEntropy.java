...
public class ThresholdMaxEntropy extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, HasAuthor, HasLicense, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        ...
        return thresholdMaxEntropy(getCLIJ2(), src, dst);
    }

    public static boolean thresholdMaxEntropy(CLIJ2 clij2, ClearCLBuffer src, ClearCLBuffer dst) {
        return clij2.automaticThreshold(src, dst, "MaxEntropy");
    }

    @Override
    public String getDescription() {
        StringBuilder doc = new StringBuilder();
        doc.append("The automatic thresholder utilizes the MaxEntropy threshold method implemented in ImageJ using a histogram determined on \n" +
