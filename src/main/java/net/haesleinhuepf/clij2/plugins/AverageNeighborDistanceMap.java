...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_averageNeighborDistanceMap")
public class AverageNeighborDistanceMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
