...
public class ResliceTop extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
    @Override
    ...
    public boolean executeCL() {
        return getCLIJ2().resliceTop((ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]));
    }
