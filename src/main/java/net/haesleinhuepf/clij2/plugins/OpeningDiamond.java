...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ2_openingDiamond")
public class OpeningDiamond extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public static boolean openingDiamond(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer output, Integer radius) {

        ClearCLBuffer temp1 = clij2.create(input);
        ClearCLBuffer temp2 = clij2.create(input);

        clij2.erodeSphere(input, temp1);
        ...
        clij2.dilateSphere(temp1, output);
