...
public class Minimum2DSphere extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        return getCLIJ2().minimum2DSphere((ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), asInteger(args[2]), asInteger(args[3]));
    }
    ...
    public String getDescription() {
        return "Computes the local minimum of a pixels ellipsoidal neighborhood. \n\nThe ellipses size is specified by \n" +
