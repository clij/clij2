...
public class Maximum3DBox extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public static boolean maximum3DBox(CLIJ2 clij2, ClearCLImageInterface src, ClearCLImageInterface dst, int radiusX, int radiusY, int radiusZ) {
        return maximumBox(clij2, src, dst, radiusX, radiusY, radiusZ);
    }

    public static boolean maximumBox(CLIJ2 clij2, ClearCLImageInterface src, ClearCLImageInterface dst, int radiusX, int radiusY, int radiusZ) {
