...
public class Maximum3DBox extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, ProcessableInTiles, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        ...
        return getCLIJ2().maximum3DBox((ClearCLBuffer) (args[0]), (ClearCLBuffer) (args[1]), radiusX, radiusY, radiusZ);
    }
    ...
    public String getDescription() {
        return "Computes the local maximum of a pixels cube neighborhood. \n\nThe cubes size is specified by \n" +
