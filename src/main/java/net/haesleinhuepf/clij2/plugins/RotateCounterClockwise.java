...
public class RotateCounterClockwise extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public String getDescription() {
        return "Rotates a given input image by 90 degrees counter-clockwise. \n\nFor that, X and Y axis of an image stack\n" +
