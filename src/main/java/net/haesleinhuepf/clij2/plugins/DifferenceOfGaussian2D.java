...
public class DifferenceOfGaussian2D extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public static boolean differenceOfGaussian(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer output, Float sigma1x, Float sigma1y, Float sigma2x, Float sigma2y) {
        ...
        clij2.gaussianBlur(input, temp1, sigma1x, sigma1y);
        clij2.gaussianBlur(input, temp2, sigma2x, sigma2y);
