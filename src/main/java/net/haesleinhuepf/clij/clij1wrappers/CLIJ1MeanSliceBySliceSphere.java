...
public class CLIJ1MeanSliceBySliceSphere{
     ...
     */
    public boolean meanSliceBySliceSphere(CLIJ clij, ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
