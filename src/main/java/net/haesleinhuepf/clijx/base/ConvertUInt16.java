...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_convertUInt16")
public class ConvertUInt16 extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    private ClearCLBuffer convertUInt16(CLIJx cliJx, ClearCLBuffer input) {
    ...
    public ClearCLBuffer createOutputBufferFromSource(ClearCLBuffer input) {
        return getCLIJx().create(input.getDimensions(), NativeTypeEnum.UnsignedShort);
    }
}
