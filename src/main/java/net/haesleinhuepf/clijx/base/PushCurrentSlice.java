...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_pushCurrentSlice")
public class PushCurrentSlice extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
