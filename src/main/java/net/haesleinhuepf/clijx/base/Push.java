...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_push")
public class Push extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
