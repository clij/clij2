...
public abstract class CLIJxOps {
   ...
   protected CLIJx clijx;
     ...
     * there is no other pixel in a given radius which has a higher intensity, and to 0 otherwise.
     */
    public boolean watershed(ClearCLBuffer source, ClearCLBuffer destination) {
        return Watershed.watershed(clijx, source, destination);
    }
    ...
    // net.haesleinhuepf.clij.customconvolutionplugin.Sobel
    //----------------------------------------------------
    /**
     * 
     */
    public boolean convolveWithSobel(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return Sobel.convolveWithSobel(clij, arg1, arg2);
    }
