...
import net.haesleinhuepf.clij.advancedfilters.StatisticsOfMaskedPixels;
...
public class CLIJxOps {
   ...
   public CLIJxOps(CLIJ clij) {
     ...
     */
    public boolean replaceIntensity(ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3, Float arg4) {
    ...
    // net.haesleinhuepf.clij.advancedfilters.StatisticsOfMaskedPixels
    //----------------------------------------------------
    /**
     ...
     */
    public double[][] statisticsOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4) {
        return StatisticsOfMaskedPixels.statisticsOfMaskedPixels(clij, arg1, arg2, arg3, arg4);
    }

    /**
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public double[] statisticsOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3) {
        return StatisticsOfMaskedPixels.statisticsOfMaskedPixels(clij, arg1, arg2, arg3);
    }

    /**
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public double[][] statisticsOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return StatisticsOfMaskedPixels.statisticsOfMaskedPixels(clij, arg1, arg2);
    }
