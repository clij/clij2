...
public abstract class CLIJxOps {
   ...
   protected CLIJx clijx;
     ...
     * such as interpolation.
     */
    public boolean rotate_left(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.rotateLeft(clij, source, destination);
    }
     ...
     * such as interpolation.
     */
    public boolean rotate_left(ClearCLImage source, ClearCLImage destination) {
        return Kernels.rotateLeft(clij, source, destination);
    }
     ...
     * such as interpolation.
     */
    public boolean rotate_right(ClearCLImage source, ClearCLImage destination) {
        return Kernels.rotateRight(clij, source, destination);
    }
     ...
     * such as interpolation.
     */
    public boolean rotate_right(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.rotateRight(clij, source, destination);
    }
     ...
     * 
     */
    public boolean maximum_x_y_z_projection(ClearCLBuffer source, ClearCLBuffer destination_max, double dimensionX, double dimensionY, double projectedDimension) {
        return Kernels.maximumXYZProjection(clij, source, destination_max, new Double (dimensionX).intValue(), new Double (dimensionY).intValue(), new Double (projectedDimension).intValue());
    }
     ...
     * 
     */
    public boolean maximum_x_y_z_projection(ClearCLImage source, ClearCLImage destination_max, double dimensionX, double dimensionY, double projectedDimension) {
        return Kernels.maximumXYZProjection(clij, source, destination_max, new Double (dimensionX).intValue(), new Double (dimensionY).intValue(), new Double (projectedDimension).intValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean minimum_slice_by_slice_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.minimumSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean minimum_slice_by_slice_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.minimumSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * <pre>f(x, y, a, b) = x * a + y * b</pre>
     */
    public boolean add_images_weighted(ClearCLImage summand1, ClearCLImage summand2, ClearCLImage destination, double factor1, double factor2) {
        return Kernels.addImagesWeighted(clij, summand1, summand2, destination, new Double (factor1).floatValue(), new Double (factor2).floatValue());
    }
     ...
     * <pre>f(x, y, a, b) = x * a + y * b</pre>
     */
    public boolean add_images_weighted(ClearCLBuffer summand1, ClearCLBuffer summand2, ClearCLBuffer destination, double factor1, double factor2) {
        return Kernels.addImagesWeighted(clij, summand1, summand2, destination, new Double (factor1).floatValue(), new Double (factor2).floatValue());
    }
     ...
     * <pre>f(x, s) = x * s</pre>
     */
    public boolean multiply_image_and_scalar(ClearCLImage source, ClearCLImage destination, double scalar) {
        return Kernels.multiplyImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * <pre>f(x, s) = x * s</pre>
     */
    public boolean multiply_image_and_scalar(ClearCLBuffer source, ClearCLBuffer destination, double scalar) {
        return Kernels.multiplyImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * Furthermore, another 2D image is generated with pixels containing the z-index where the maximum was found (zero based).
     */
    public boolean arg_maximum_z_projection(ClearCLBuffer source, ClearCLBuffer destination_max, ClearCLBuffer destination_arg_max) {
        return Kernels.argMaximumZProjection(clij, source, destination_max, destination_arg_max);
    }
     ...
     * Furthermore, another 2D image is generated with pixels containing the z-index where the maximum was found (zero based).
     */
    public boolean arg_maximum_z_projection(ClearCLImage source, ClearCLImage destination_max, ClearCLImage destination_arg_max) {
        return Kernels.argMaximumZProjection(clij, source, destination_max, destination_arg_max);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean dilate_box_slice_by_slice(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.dilateBoxSliceBySlice(clij, source, destination);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean dilate_box_slice_by_slice(ClearCLImage source, ClearCLImage destination) {
        return Kernels.dilateBoxSliceBySlice(clij, source, destination);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean erode_sphere_slice_by_slice(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.erodeSphereSliceBySlice(clij, source, destination);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean erode_sphere_slice_by_slice(ClearCLImage source, ClearCLImage destination) {
        return Kernels.erodeSphereSliceBySlice(clij, source, destination);
    }
     ...
     * 
     */
    public boolean multiply_slice_by_slice_with_scalars(ClearCLBuffer arg1, ClearCLBuffer arg2, float[] arg3) {
        return Kernels.multiplySliceBySliceWithScalars(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public boolean multiply_slice_by_slice_with_scalars(ClearCLImage arg1, ClearCLImage arg2, float[] arg3) {
        return Kernels.multiplySliceBySliceWithScalars(clij, arg1, arg2, arg3);
    }
     ...
     * [Default, Huang, Intermodes, IsoData, IJ_IsoData, Li, MaxEntropy, Mean, MinError, Minimum, Moments, Otsu, Percentile, RenyiEntropy, Shanbhag, Triangle, Yen]
     */
    public boolean automatic_threshold(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3) {
        return Kernels.automaticThreshold(clij, arg1, arg2, arg3);
    }
     ...
     * [Default, Huang, Intermodes, IsoData, IJ_IsoData, Li, MaxEntropy, Mean, MinError, Minimum, Moments, Otsu, Percentile, RenyiEntropy, Shanbhag, Triangle, Yen]
     */
    public boolean automatic_threshold(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3, double arg4, double arg5, double arg6) {
        return Kernels.automaticThreshold(clij, arg1, arg2, arg3, new Double (arg4).floatValue(), new Double (arg5).floatValue(), new Double (arg6).intValue());
    }
     ...
     * 
     */
    public boolean convert_to_image_j_binary(ClearCLImage arg1, ClearCLImage arg2) {
        return Kernels.convertToImageJBinary(clij, arg1, arg2);
    }
     ...
     * 
     */
    public boolean convert_to_image_j_binary(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return Kernels.convertToImageJBinary(clij, arg1, arg2);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean erode_box_slice_by_slice(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.erodeBoxSliceBySlice(clij, source, destination);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean erode_box_slice_by_slice(ClearCLImage source, ClearCLImage destination) {
        return Kernels.erodeBoxSliceBySlice(clij, source, destination);
    }
     ...
     * 
     */
    public boolean count_non_zero_pixels_locally(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
        return Kernels.countNonZeroPixelsLocally(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue());
    }
     ...
     * 
     */
    public boolean count_non_zero_pixels_locally(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4) {
        return Kernels.countNonZeroPixelsLocally(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue());
    }
     ...
     * <pre>f(x, s) = x + s</pre>
     */
    public boolean add_image_and_scalar(ClearCLBuffer source, ClearCLBuffer destination, double scalar) {
        return Kernels.addImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * <pre>f(x, s) = x + s</pre>
     */
    public boolean add_image_and_scalar(ClearCLImage source, ClearCLImage destination, double scalar) {
        return Kernels.addImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * given radius which has a lower intensity, and to 0 otherwise.
     */
    public boolean detect_minima_slice_by_slice_box(ClearCLBuffer source, ClearCLBuffer destination, double radius) {
        return Kernels.detectMinimaSliceBySliceBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * given radius which has a lower intensity, and to 0 otherwise.
     */
    public boolean detect_minima_slice_by_slice_box(ClearCLImage source, ClearCLImage destination, double radius) {
        return Kernels.detectMinimaSliceBySliceBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean maximum_slice_by_slice_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.maximumSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean maximum_slice_by_slice_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.maximumSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * <pre>f(x, y) = x * y</pre>
     */
    public boolean multiply_stack_with_plane(ClearCLBuffer sourceStack, ClearCLBuffer sourcePlane, ClearCLBuffer destination) {
        return Kernels.multiplyStackWithPlane(clij, sourceStack, sourcePlane, destination);
    }
     ...
     * <pre>f(x, y) = x * y</pre>
     */
    public boolean multiply_stack_with_plane(ClearCLImage sourceStack, ClearCLImage sourcePlane, ClearCLImage destination) {
        return Kernels.multiplyStackWithPlane(clij, sourceStack, sourcePlane, destination);
    }
     ...
     * Results table in the column 'Max'.
     */
    public double maximum_of_all_pixels(ClearCLBuffer source) {
        return Kernels.maximumOfAllPixels(clij, source);
    }
     ...
     * Results table in the column 'Max'.
     */
    public double maximum_of_all_pixels(ClearCLImage source) {
        return Kernels.maximumOfAllPixels(clij, source);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean dilate_sphere_slice_by_slice(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.dilateSphereSliceBySlice(clij, source, destination);
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean dilate_sphere_slice_by_slice(ClearCLImage source, ClearCLImage destination) {
        return Kernels.dilateSphereSliceBySlice(clij, source, destination);
    }
     ...
     * For technical reasons, the area of the ellipse must have less than 1000 pixels.
     */
    public boolean median_slice_by_slice_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.medianSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the ellipse must have less than 1000 pixels.
     */
    public boolean median_slice_by_slice_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.medianSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * Results table in the column 'Min'.
     */
    public double minimum_of_all_pixels(ClearCLBuffer source) {
        return Kernels.minimumOfAllPixels(clij, source);
    }
     ...
     * Results table in the column 'Min'.
     */
    public double minimum_of_all_pixels(ClearCLImage source) {
        return Kernels.minimumOfAllPixels(clij, source);
    }
     ...
     * 
     */
    public boolean tenengrad_weights_slice_by_slice(ClearCLImage arg1, ClearCLImage arg2) {
        return Kernels.tenengradWeightsSliceBySlice(clij, arg1, arg2);
    }
     ...
     * 
     */
    public double[] sum_pixels_slice_by_slice(ClearCLBuffer arg1) {
        return Kernels.sumPixelsSliceBySlice(clij, arg1);
    }
     ...
     * 
     */
    public double[] sum_pixels_slice_by_slice(ClearCLImage arg1) {
        return Kernels.sumPixelsSliceBySlice(clij, arg1);
    }
     ...
     * Determines the minimum projection of an image along Z.
     */
    public boolean minimum_z_projection(ClearCLImage source, ClearCLImage destination_sum) {
        return Kernels.minimumZProjection(clij, source, destination_sum);
    }
     ...
     * Determines the minimum projection of an image along Z.
     */
    public boolean minimum_z_projection(ClearCLBuffer source, ClearCLBuffer destination_sum) {
        return Kernels.minimumZProjection(clij, source, destination_sum);
    }
     ...
     * 
     */
    public boolean multiply_image_and_coordinate(ClearCLImage arg1, ClearCLImage arg2, double arg3) {
        return Kernels.multiplyImageAndCoordinate(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * 
     */
    public boolean multiply_image_and_coordinate(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return Kernels.multiplyImageAndCoordinate(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_2_d(ClearCLBuffer arg1, ClearCLBuffer arg2, float[] arg3) {
        return Kernels.affineTransform2D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_2_d(ClearCLImage arg1, ClearCLImage arg2, AffineTransform2D arg3) {
        return Kernels.affineTransform2D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_2_d(ClearCLBuffer arg1, ClearCLBuffer arg2, AffineTransform2D arg3) {
        return Kernels.affineTransform2D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_2_d(ClearCLImage arg1, ClearCLImage arg2, float[] arg3) {
        return Kernels.affineTransform2D(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public boolean count_non_zero_voxels_locally(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.countNonZeroVoxelsLocally(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * 
     */
    public boolean count_non_zero_voxels_locally(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.countNonZeroVoxelsLocally(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * given radius which has a higher intensity, and to 0 otherwise.
     */
    public boolean detect_maxima_slice_by_slice_box(ClearCLBuffer source, ClearCLBuffer destination, double radius) {
        return Kernels.detectMaximaSliceBySliceBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * given radius which has a higher intensity, and to 0 otherwise.
     */
    public boolean detect_maxima_slice_by_slice_box(ClearCLImage source, ClearCLImage destination, double radius) {
        return Kernels.detectMaximaSliceBySliceBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * 
     */
    public boolean detect_optima_slice_by_slice(ClearCLImage arg1, ClearCLImage arg2, double arg3, boolean arg4) {
        return Kernels.detectOptimaSliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), arg4);
    }
     ...
     * 
     */
    public boolean detect_optima_slice_by_slice(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, boolean arg4) {
        return Kernels.detectOptimaSliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), arg4);
    }
     ...
     * four corresponding pixels in the source image.
     */
    public boolean downsample_slice_by_slice_half_median(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.downsampleSliceBySliceHalfMedian(clij, source, destination);
    }
     ...
     * four corresponding pixels in the source image.
     */
    public boolean downsample_slice_by_slice_half_median(ClearCLImage source, ClearCLImage destination) {
        return Kernels.downsampleSliceBySliceHalfMedian(clij, source, destination);
    }
     ...
     * 
     */
    public boolean difference_of_gaussian_slice_by_slice(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.differenceOfGaussianSliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue());
    }
     ...
     * <pre>f(x, s) = min(x, s)</pre>
     */
    public boolean minimum_image_and_scalar(ClearCLImage source, ClearCLImage destination, double scalar) {
        return Kernels.minimumImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * <pre>f(x, s) = min(x, s)</pre>
     */
    public boolean minimum_image_and_scalar(ClearCLBuffer source, ClearCLBuffer destination, double scalar) {
        return Kernels.minimumImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * Applies Gaussian blur to the input image twice resulting in two images which are then subtracted from each other.
     */
    public boolean difference_of_gaussian(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.differenceOfGaussian(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue());
    }
     ...
     * Determines the maximum projection of an image along Z.
     */
    public boolean maximum_z_projection(ClearCLImage source, ClearCLImage destination_max) {
        return Kernels.maximumZProjection(clij, source, destination_max);
    }
     ...
     * Determines the maximum projection of an image along Z.
     */
    public boolean maximum_z_projection(ClearCLBuffer source, ClearCLBuffer destination_max) {
        return Kernels.maximumZProjection(clij, source, destination_max);
    }
     ...
     * <pre>f(x,m) = (x if (m != 0); (0 otherwise))</pre>
     */
    public boolean mask_stack_with_plane(ClearCLBuffer source, ClearCLBuffer mask, ClearCLBuffer destination) {
        return Kernels.maskStackWithPlane(clij, source, mask, destination);
    }
     ...
     * <pre>f(x,m) = (x if (m != 0); (0 otherwise))</pre>
     */
    public boolean mask_stack_with_plane(ClearCLImage source, ClearCLImage mask, ClearCLImage destination) {
        return Kernels.maskStackWithPlane(clij, source, mask, destination);
    }
     ...
     * <pre>f(x, s) = max(x, s)</pre>
     */
    public boolean maximum_image_and_scalar(ClearCLBuffer source, ClearCLBuffer destination, double scalar) {
        return Kernels.maximumImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * <pre>f(x, s) = max(x, s)</pre>
     */
    public boolean maximum_image_and_scalar(ClearCLImage source, ClearCLImage destination, double scalar) {
        return Kernels.maximumImageAndScalar(clij, source, destination, new Double (scalar).floatValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean mean_slice_by_slice_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.meanSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * This filter is applied slice by slice in 2D.
     */
    public boolean mean_slice_by_slice_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.meanSliceBySliceSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_slice_by_slice_box(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.medianSliceBySliceBox(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_slice_by_slice_box(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.medianSliceBySliceBox(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_3_d(ClearCLImage arg1, ClearCLImage arg2, AffineTransform3D arg3) {
        return Kernels.affineTransform3D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_3_d(ClearCLImage arg1, ClearCLImage arg2, float[] arg3) {
        return Kernels.affineTransform3D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_3_d(ClearCLBuffer arg1, ClearCLBuffer arg2, float[] arg3) {
        return Kernels.affineTransform3D(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform_3_d(ClearCLBuffer arg1, ClearCLBuffer arg2, AffineTransform3D arg3) {
        return Kernels.affineTransform3D(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public boolean count_non_zero_pixels_locally_slice_by_slice(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4) {
        return Kernels.countNonZeroPixelsLocallySliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue());
    }
     ...
     * 
     */
    public boolean count_non_zero_pixels_locally_slice_by_slice(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
        return Kernels.countNonZeroPixelsLocallySliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue());
    }
     ...
     * <pre>f(x, y) = x - y</pre>
     */
    public boolean subtract_images(ClearCLImage subtrahend, ClearCLImage minuend, ClearCLImage destination) {
        return Kernels.subtractImages(clij, subtrahend, minuend, destination);
    }
     ...
     * <pre>f(x, y) = x - y</pre>
     */
    public boolean subtract_images(ClearCLBuffer subtrahend, ClearCLBuffer minuend, ClearCLBuffer destination) {
        return Kernels.subtractImages(clij, subtrahend, minuend, destination);
    }
     ...
     * 
     */
    public boolean split_stack(ClearCLImage arg1, ClearCLImage[] arg2) {
        return Kernels.splitStack(clij, arg1, arg2);
    }
     ...
     * 
     */
    public boolean split_stack(ClearCLBuffer arg1, ClearCLBuffer[] arg2) {
        return Kernels.splitStack(clij, arg1, arg2);
    }
     ...
     * offers less flexibility such as interpolation.
     */
    public boolean reslice_top(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.resliceTop(clij, source, destination);
    }
     ...
     * offers less flexibility such as interpolation.
     */
    public boolean reslice_top(ClearCLImage source, ClearCLImage destination) {
        return Kernels.resliceTop(clij, source, destination);
    }
     ...
     * This method is deprecated. Consider using maximumBox or maximumSphere instead.
     */
    public boolean maximum_i_j(ClearCLImage arg1, ClearCLImage arg2, double arg3) {
        return Kernels.maximumIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * This method is deprecated. Consider using maximumBox or maximumSphere instead.
     */
    public boolean maximum_i_j(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return Kernels.maximumIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * <pre>f(x, y) = min(x, y)</pre>
     */
    public boolean minimum_images(ClearCLImage source1, ClearCLImage source2, ClearCLImage destination) {
        return Kernels.minimumImages(clij, source1, source2, destination);
    }
     ...
     * <pre>f(x, y) = min(x, y)</pre>
     */
    public boolean minimum_images(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
        return Kernels.minimumImages(clij, source1, source2, destination);
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_box(ClearCLImage arg1, ClearCLImage arg2, int arg3, int arg4, int arg5) {
        return Kernels.meanBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_box(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4, int arg5) {
        return Kernels.meanBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * Results table in the column 'Sum'.
     */
    public double sum_pixels(ClearCLBuffer source) {
        return Kernels.sumPixels(clij, source);
    }
     ...
     * Results table in the column 'Sum'.
     */
    public double sum_pixels(ClearCLImage source) {
        return Kernels.sumPixels(clij, source);
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_sphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.medianSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.medianSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.medianSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_sphere(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.medianSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_box(ClearCLImage arg1, ClearCLImage arg2, int arg3, int arg4, int arg5) {
        return Kernels.minimumBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_box(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4, int arg5) {
        return Kernels.minimumBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * This method is deprecated. Consider using minimumBox or minimumSphere instead.
     */
    public boolean minimum_i_j(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return Kernels.minimumIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * This method is deprecated. Consider using minimumBox or minimumSphere instead.
     */
    public boolean minimum_i_j(ClearCLImage arg1, ClearCLImage arg2, double arg3) {
        return Kernels.minimumIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * The pixels in the input image with pixel value not equal to 0 will be interpreted as 1.
     */
    public boolean erode_sphere(ClearCLImage source, ClearCLImage destination) {
        return Kernels.erodeSphere(clij, source, destination);
    }
     ...
     * The pixels in the input image with pixel value not equal to 0 will be interpreted as 1.
     */
    public boolean erode_sphere(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.erodeSphere(clij, source, destination);
    }
     ...
     * offers less flexibility such as interpolation.
     */
    public boolean reslice_bottom(ClearCLImage source, ClearCLImage destination) {
        return Kernels.resliceBottom(clij, source, destination);
    }
     ...
     * offers less flexibility such as interpolation.
     */
    public boolean reslice_bottom(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.resliceBottom(clij, source, destination);
    }
     ...
     * Determines the sum projection of an image along Z.
     */
    public boolean sum_z_projection(ClearCLImage source, ClearCLImage destination_sum) {
        return Kernels.sumZProjection(clij, source, destination_sum);
    }
     ...
     * Determines the sum projection of an image along Z.
     */
    public boolean sum_z_projection(ClearCLBuffer source, ClearCLBuffer destination_sum) {
        return Kernels.sumZProjection(clij, source, destination_sum);
    }
     ...
     * 
     */
    public boolean radial_projection(ClearCLImage arg1, ClearCLImage arg2, double arg3) {
        return Kernels.radialProjection(clij, arg1, arg2, new Double (arg3).floatValue());
    }
     ...
     * 
     */
    public boolean radial_projection(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return Kernels.radialProjection(clij, arg1, arg2, new Double (arg3).floatValue());
    }
     ...
     * <pre>f(x) = (1 if (x >=  m)); (0 otherwise)</pre>
     */
    public boolean local_threshold(ClearCLImage source, ClearCLImage localThreshold, ClearCLImage destination) {
        return Kernels.localThreshold(clij, source, localThreshold, destination);
    }
     ...
     * <pre>f(x) = (1 if (x >=  m)); (0 otherwise)</pre>
     */
    public boolean local_threshold(ClearCLBuffer source, ClearCLBuffer localThreshold, ClearCLBuffer destination) {
        return Kernels.localThreshold(clij, source, localThreshold, destination);
    }
     ...
     * 
     */
    public boolean fill_histogram(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
        return Kernels.fillHistogram(clij, arg1, arg2, new Double (arg3).floatValue(), new Double (arg4).floatValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_sphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.minimumSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.minimumSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.minimumSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean minimum_sphere(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.minimumSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_sphere(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.maximumSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.maximumSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.maximumSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_sphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.maximumSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_box(ClearCLImage arg1, ClearCLImage arg2, int arg3, int arg4, int arg5) {
        return Kernels.maximumBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean maximum_box(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4, int arg5) {
        return Kernels.maximumBox(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     *  pixels in Z direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_z(ClearCLImage source, ClearCLImage destination) {
        return Kernels.gradientZ(clij, source, destination);
    }
     ...
     *  pixels in Z direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_z(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.gradientZ(clij, source, destination);
    }
     ...
     *  pixels in X direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_x(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.gradientX(clij, source, destination);
    }
     ...
     *  pixels in X direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_x(ClearCLImage source, ClearCLImage destination) {
        return Kernels.gradientX(clij, source, destination);
    }
     ...
     * <pre>f(x, y) = max(x, y)</pre>
     */
    public boolean maximum_images(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
        return Kernels.maximumImages(clij, source1, source2, destination);
    }
     ...
     * <pre>f(x, y) = max(x, y)</pre>
     */
    public boolean maximum_images(ClearCLImage source1, ClearCLImage source2, ClearCLImage destination) {
        return Kernels.maximumImages(clij, source1, source2, destination);
    }
     ...
     * Determines the mean average projection of an image along Z.
     */
    public boolean mean_z_projection(ClearCLImage source, ClearCLImage destination) {
        return Kernels.meanZProjection(clij, source, destination);
    }
     ...
     * Determines the mean average projection of an image along Z.
     */
    public boolean mean_z_projection(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.meanZProjection(clij, source, destination);
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_sphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.meanSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_sphere(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.meanSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_sphere(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.meanSphere(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * its half-width and half-height (radius).
     */
    public boolean mean_sphere(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.meanSphere(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * difference is that the output image contains values 0 and 1 instead of 0 and 255.
     */
    public boolean erode_box(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.erodeBox(clij, source, destination);
    }
     ...
     * difference is that the output image contains values 0 and 1 instead of 0 and 255.
     */
    public boolean erode_box(ClearCLImage source, ClearCLImage destination) {
        return Kernels.erodeBox(clij, source, destination);
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_box(ClearCLImage source, ClearCLImage destination, double radiusX, double radiusY) {
        return Kernels.medianBox(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_box(ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
        return Kernels.medianBox(clij, source, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_box(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5) {
        return Kernels.medianBox(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    public boolean median_box(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return Kernels.medianBox(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     * <pre>f(x, y) = x * y</pre>
     */
    public boolean multiply_images(ClearCLBuffer factor1, ClearCLBuffer factor2, ClearCLBuffer destination) {
        return Kernels.multiplyImages(clij, factor1, factor2, destination);
    }
     ...
     * <pre>f(x, y) = x * y</pre>
     */
    public boolean multiply_images(ClearCLImage factor1, ClearCLImage factor2, ClearCLImage destination) {
        return Kernels.multiplyImages(clij, factor1, factor2, destination);
    }
     ...
     *  pixels in Y direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_y(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.gradientY(clij, source, destination);
    }
     ...
     *  pixels in Y direction. In the target image will be saved as: <pre>b' = c - a;</pre>
     */
    public boolean gradient_y(ClearCLImage source, ClearCLImage destination) {
        return Kernels.gradientY(clij, source, destination);
    }
     ...
     *  but offers less flexibility such as interpolation.
     */
    public boolean reslice_right(ClearCLImage source, ClearCLImage destination) {
        return Kernels.resliceRight(clij, source, destination);
    }
     ...
     *  but offers less flexibility such as interpolation.
     */
    public boolean reslice_right(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.resliceRight(clij, source, destination);
    }
     ...
     * This method is deprecated. Consider using meanBox or meanSphere instead.
     */
    public boolean mean_i_j(ClearCLImage arg1, ClearCLImage arg2, double arg3) {
        return Kernels.meanIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     * This method is deprecated. Consider using meanBox or meanSphere instead.
     */
    public boolean mean_i_j(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return Kernels.meanIJ(clij, arg1, arg2, new Double (arg3).intValue());
    }
     ...
     *  but offers less flexibility such as interpolation.
     */
    public boolean reslice_left(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.resliceLeft(clij, source, destination);
    }
     ...
     *  but offers less flexibility such as interpolation.
     */
    public boolean reslice_left(ClearCLImage source, ClearCLImage destination) {
        return Kernels.resliceLeft(clij, source, destination);
    }
     ...
     * 
     */
    public boolean tenengrad_fusion(ClearCLImage arg1, float[] arg2, float arg3, ClearCLImage[] arg4) {
        return Kernels.tenengradFusion(clij, arg1, arg2, arg3, arg4);
    }
     ...
     * 
     */
    public boolean tenengrad_fusion(ClearCLImage arg1, float[] arg2, ClearCLImage[] arg3) {
        return Kernels.tenengradFusion(clij, arg1, arg2, arg3);
    }
     ...
     * difference is that the output image contains values 0 and 1 instead of 0 and 255.
     */
    public boolean dilate_box(ClearCLImage source, ClearCLImage destination) {
        return Kernels.dilateBox(clij, source, destination);
    }
     ...
     * difference is that the output image contains values 0 and 1 instead of 0 and 255.
     */
    public boolean dilate_box(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.dilateBox(clij, source, destination);
    }
     ...
     * The pixels in the input image with pixel value not equal to 0 will be interpreted as 1.
     */
    public boolean dilate_sphere(ClearCLImage source, ClearCLImage destination) {
        return Kernels.dilateSphere(clij, source, destination);
    }
     ...
     * The pixels in the input image with pixel value not equal to 0 will be interpreted as 1.
     */
    public boolean dilate_sphere(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.dilateSphere(clij, source, destination);
    }
     ...
     * <pre>f(x, y) = x / y</pre>
     */
    public boolean divide_images(ClearCLImage divident, ClearCLImage divisor, ClearCLImage destination) {
        return Kernels.divideImages(clij, divident, divisor, destination);
    }
     ...
     * <pre>f(x, y) = x / y</pre>
     */
    public boolean divide_images(ClearCLBuffer divident, ClearCLBuffer divisor, ClearCLBuffer destination) {
        return Kernels.divideImages(clij, divident, divisor, destination);
    }
     ...
     * 
     */
    public boolean detect_optima(ClearCLImage arg1, ClearCLImage arg2, double arg3, boolean arg4) {
        return Kernels.detectOptima(clij, arg1, arg2, new Double (arg3).intValue(), arg4);
    }
     ...
     * 
     */
    public boolean detect_optima(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, boolean arg4) {
        return Kernels.detectOptima(clij, arg1, arg2, new Double (arg3).intValue(), arg4);
    }
     ...
     * <pre>f(x, y) = x + y</pre>
     */
    public boolean add_images(ClearCLBuffer summand1, ClearCLBuffer summand2, ClearCLBuffer destination) {
        return Kernels.addImages(clij, summand1, summand2, destination);
    }
     ...
     * <pre>f(x, y) = x + y</pre>
     */
    public boolean add_images(ClearCLImage summand1, ClearCLImage summand2, ClearCLImage destination) {
        return Kernels.addImages(clij, summand1, summand2, destination);
    }
    ...
    /**
     * CLIJ affine_transform is deprecated. Use affine_transform2D or affine_transform3D instead.
     * 
     * Applies an affine transform to a 3D image. Individual transforms must be separated by spaces.
     * 
     * Supported transforms:
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform(ClearCLImage arg1, ClearCLImage arg2, float[] arg3) {
        return Kernels.affineTransform(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform(ClearCLImage arg1, ClearCLImage arg2, AffineTransform3D arg3) {
        return Kernels.affineTransform(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform(ClearCLBuffer arg1, ClearCLBuffer arg2, AffineTransform3D arg3) {
        return Kernels.affineTransform(clij, arg1, arg2, arg3);
    }
     ...
     * transform = "center scale=2 rotate=45 -center";
     */
    public boolean affine_transform(ClearCLBuffer arg1, ClearCLBuffer arg2, float[] arg3) {
        return Kernels.affineTransform(clij, arg1, arg2, arg3);
    }
     ...
     * <pre>f(x, y) = x & y</pre>
     */
    public boolean binary_and(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
        return Kernels.binaryAnd(clij, operand1, operand2, destination);
    }
     ...
     * <pre>f(x, y) = x & y</pre>
     */
    public boolean binary_and(ClearCLImage operand1, ClearCLImage operand2, ClearCLImage destination) {
        return Kernels.binaryAnd(clij, operand1, operand2, destination);
    }
     ...
     * <pre>f(x) = !x</pre>
     */
    public boolean binary_not(ClearCLImage source, ClearCLImage destination) {
        return Kernels.binaryNot(clij, source, destination);
    }
     ...
     * <pre>f(x) = !x</pre>
     */
    public boolean binary_not(ClearCLBuffer source, ClearCLBuffer destination) {
        return Kernels.binaryNot(clij, source, destination);
    }
     ...
     * the image stack with z planes.
     */
    public boolean copy_slice(ClearCLBuffer source, ClearCLBuffer destination, double sliceIndex) {
        return Kernels.copySlice(clij, source, destination, new Double (sliceIndex).intValue());
    }
     ...
     * the image stack with z planes.
     */
    public boolean copy_slice(ClearCLImage source, ClearCLImage destination, double sliceIndex) {
        return Kernels.copySlice(clij, source, destination, new Double (sliceIndex).intValue());
    }
     ...
     * All pixel values except 0 in the input images are interpreted as 1.<pre>f(x, y) = x | y</pre>
     */
    public boolean binary_or(ClearCLImage operand1, ClearCLImage operand2, ClearCLImage destination) {
        return Kernels.binaryOr(clij, operand1, operand2, destination);
    }
     ...
     * All pixel values except 0 in the input images are interpreted as 1.<pre>f(x, y) = x | y</pre>
     */
    public boolean binary_or(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
        return Kernels.binaryOr(clij, operand1, operand2, destination);
    }
     ...
     * Deforms an image according to distances provided in the given vector images. It is recommended to use 32-bit images for input, output and vector images. 
     */
    public boolean apply_vectorfield(ClearCLBuffer source, ClearCLBuffer vectorX, ClearCLBuffer vectorY, ClearCLBuffer destination) {
        return Kernels.applyVectorfield(clij, source, vectorX, vectorY, destination);
    }
     ...
     * Deforms an image according to distances provided in the given vector images. It is recommended to use 32-bit images for input, output and vector images. 
     */
    public boolean apply_vectorfield(ClearCLImage arg1, ClearCLImage arg2, ClearCLImage arg3, ClearCLImage arg4, ClearCLImage arg5) {
        return Kernels.applyVectorfield(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * Deforms an image according to distances provided in the given vector images. It is recommended to use 32-bit images for input, output and vector images. 
     */
    public boolean apply_vectorfield(ClearCLImage source, ClearCLImage vectorX, ClearCLImage vectorY, ClearCLImage destination) {
        return Kernels.applyVectorfield(clij, source, vectorX, vectorY, destination);
    }
     ...
     * Deforms an image according to distances provided in the given vector images. It is recommended to use 32-bit images for input, output and vector images. 
     */
    public boolean apply_vectorfield(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, ClearCLBuffer arg5) {
        return Kernels.applyVectorfield(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * The Gaussian blur is applied slice by slice in 2D.
     */
    public boolean blur_slice_by_slice(ClearCLImage arg1, ClearCLImage arg2, double arg3, double arg4, double arg5, double arg6) {
        return Kernels.blurSliceBySlice(clij, arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).floatValue(), new Double (arg6).floatValue());
    }
     ...
     * The Gaussian blur is applied slice by slice in 2D.
     */
    public boolean blur_slice_by_slice(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4, float arg5, float arg6) {
        return Kernels.blurSliceBySlice(clij, arg1, arg2, arg3, arg4, arg5, arg6);
    }
     ...
     * there is no other pixel in a given radius which has a higher intensity, and to 0 otherwise.
     */
    public boolean detect_maxima_box(ClearCLBuffer source, ClearCLBuffer destination, double radius) {
        return Kernels.detectMaximaBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * there is no other pixel in a given radius which has a higher intensity, and to 0 otherwise.
     */
    public boolean detect_maxima_box(ClearCLImage source, ClearCLImage destination, double radius) {
        return Kernels.detectMaximaBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * <pre>f(x, y) = (x & !y) | (!x & y)</pre>
     */
    public boolean binary_x_or(ClearCLImage operand1, ClearCLImage operand2, ClearCLImage destination) {
        return Kernels.binaryXOr(clij, operand1, operand2, destination);
    }
     ...
     * <pre>f(x, y) = (x & !y) | (!x & y)</pre>
     */
    public boolean binary_x_or(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
        return Kernels.binaryXOr(clij, operand1, operand2, destination);
    }
     ...
     * there is no other pixel in a given radius which has a lower intensity, and to 0 otherwise.
     */
    public boolean detect_minima_box(ClearCLBuffer source, ClearCLBuffer destination, double radius) {
        return Kernels.detectMinimaBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * there is no other pixel in a given radius which has a lower intensity, and to 0 otherwise.
     */
    public boolean detect_minima_box(ClearCLImage source, ClearCLImage destination, double radius) {
        return Kernels.detectMinimaBox(clij, source, destination, new Double (radius).intValue());
    }
     ...
     * in the columns MassX, MassY and MassZ.
     */
    public double[] center_of_mass(ClearCLBuffer source) {
        return Kernels.centerOfMass(clij, source);
    }
     ...
     * in the columns MassX, MassY and MassZ.
     */
    public double[] center_of_mass(ClearCLImage source) {
        return Kernels.centerOfMass(clij, source);
    }
     ...
     * All pixel values except 0 in the input images are interpreted as 1.<pre>f(x, y) = x | y</pre>
     */
    public boolean binary_union(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
        return BinaryUnion.binaryUnion(clij, operand1, operand2, destination);
    }
     ...
     * <pre>f(x, y) = x & y</pre>
     */
    public boolean binary_intersection(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
        return BinaryIntersection.binaryIntersection(clij, operand1, operand2, destination);
    }
     ...
     * 
     */
    public boolean replace(ClearCLImageInterface arg1, ClearCLBuffer arg2, ClearCLImageInterface arg3) {
     ...
     * 
     */
    public boolean set_non_zero_pixels_to_pixel_index(ClearCLImageInterface arg1, ClearCLImageInterface arg2) {
        return ConnectedComponentsLabeling.setNonZeroPixelsToPixelIndex(clij, arg1, arg2);
    }
     ...
     * 
     */
    public boolean shift_intensities_to_close_gaps(ClearCLImageInterface arg1, ClearCLImageInterface arg2) {
        return ConnectedComponentsLabeling.shiftIntensitiesToCloseGaps(clij, arg1, arg2);
    }
    ...
    public boolean connectedComponentsLabeling(ClearCLBuffer binary_input, ClearCLBuffer labeling_destination) {
        return ConnectedComponentsLabeling.connectedComponentsLabeling(clij, binary_input, labeling_destination);
    }

    /**
     * Performs connected components analysis to a binary image and generates a label map.
     */
    public boolean connected_components_labeling(ClearCLBuffer binary_input, ClearCLBuffer labeling_destination) {
        return ConnectedComponentsLabeling.connectedComponentsLabeling(clij, binary_input, labeling_destination);
    }
     ...
     * Results table in the column 'Count_non_zero'.
     */
    public double count_non_zero_pixels(ClearCLBuffer source) {
        return CountNonZeroPixels.countNonZeroPixels(clij, source);
    }
     ...
     * 
     */
    public boolean cross_correlation(ClearCLImage arg1, ClearCLImage arg2, ClearCLImage arg3, ClearCLImage arg4, ClearCLImage arg5, int arg6, int arg7, int arg8) {
        return CrossCorrelation.crossCorrelation(clij, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
     ...
     * 
     */
    public boolean cross_correlation(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, ClearCLBuffer arg5, int arg6, int arg7, int arg8) {
        return CrossCorrelation.crossCorrelation(clij, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
     ...
     * Applies Gaussian blur to the input image twice resulting in two images which are then subtracted from each other.
     */
    public boolean difference_of_gaussian(ClearCLBuffer input, ClearCLBuffer destination, double sigma1x, double sigma1y, double sigma2x, double sigma2y) {
        return DifferenceOfGaussian2D.differenceOfGaussian(clij, input, destination, new Double (sigma1x).floatValue(), new Double (sigma1y).floatValue(), new Double (sigma2x).floatValue(), new Double (sigma2y).floatValue());
    }
     ...
     * Applies Gaussian blur to the input image twice resulting in two images which are then subtracted from each other.
     */
    public boolean difference_of_gaussian(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
        return DifferenceOfGaussian3D.differenceOfGaussian(clij, arg1, arg2, new Double (arg3).floatValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue(), new Double (arg6).floatValue(), new Double (arg7).floatValue(), new Double (arg8).floatValue());
    }
     ...
     * Applies a local minimum and maximum filter. Afterwards, the value is returned which is more far from zero.
     */
    public boolean local_extrema_box(ClearCLBuffer input, ClearCLBuffer destination, double radiusX, double radiusY, double radiusZ) {
        return LocalExtremaBox.localExtremaBox(clij, input, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue(), new Double (radiusZ).intValue());
    }
     ...
     * local id
     */
    public boolean local_i_d(ClearCLBuffer input, ClearCLBuffer destination) {
        return LocalID.localID(clij, input, destination);
    }
     ...
     * f(x,m,i) = (x if (m == i); (0 otherwise))
     */
    public boolean mask_label(ClearCLBuffer source, ClearCLBuffer label_map, ClearCLBuffer destination, double label_index) {
        return MaskLabel.maskLabel(clij, source, label_map, destination, new Double (label_index).floatValue());
    }
     ...
     * 
     */
    public double[] mean_closest_spot_distances(ClearCLBuffer arg1, ClearCLBuffer arg2, boolean arg3) {
        return MeanClosestSpotDistance.meanClosestSpotDistances(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public double mean_closest_spot_distances(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return MeanClosestSpotDistance.meanClosestSpotDistances(clij, arg1, arg2);
    }
     ...
     * Results table in the column 'MSE'.
     */
    public double mean_squared_error(ClearCLBuffer source1, ClearCLBuffer source2) {
        return MeanSquaredError.meanSquaredError(clij, source1, source2);
    }
     ...
     * Apply a minimum-sphere filter to the input image. The radius is fixed to 1 and pixels with value 0 are ignored.
     */
    public ClearCLKernel nonzero_minimum_diamond(ClearCLImageInterface arg1, ClearCLBuffer arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
        return NonzeroMinimumDiamond.nonzeroMinimumDiamond(clijx, arg1, arg2, arg3, arg4);
    }
     ...
     * Apply a minimum-sphere filter to the input image. The radius is fixed to 1 and pixels with value 0 are ignored.
     */
    public boolean nonzero_minimum_diamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return NonzeroMinimumDiamond.nonzeroMinimumDiamond(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public double sorensen_dice_coefficient(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return SorensenDiceJaccardIndex.sorensenDiceCoefficient(clij, arg1, arg2);
    }
     ...
     * 
     */
    public double jaccard_index(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return SorensenDiceJaccardIndex.jaccardIndex(clij, arg1, arg2);
    }
     ...
     * Stack to tiles.
     */
    public boolean stack_to_tiles(ClearCLImage source, ClearCLImage destination, double tiles_x, double tiles_y) {
        return StackToTiles.stackToTiles(clij, source, destination, new Double (tiles_x).intValue(), new Double (tiles_y).intValue());
    }
     ...
     * Stack to tiles.
     */
    public boolean stack_to_tiles(ClearCLBuffer source, ClearCLBuffer destination, double tiles_x, double tiles_y) {
        return StackToTiles.stackToTiles(clij, source, destination, new Double (tiles_x).intValue(), new Double (tiles_y).intValue());
    }
     ...
     * Applies Gaussian blur to the input image and subtracts the result from the original image.
     */
    public boolean subtract_background(ClearCLBuffer input, ClearCLBuffer destination, double sigmaX, double sigmaY) {
        return SubtractBackground2D.subtractBackground(clij, input, destination, new Double (sigmaX).floatValue(), new Double (sigmaY).floatValue());
    }
     ...
     * Applies Gaussian blur to the input image and subtracts the result from the original image.
     */
    public boolean subtract_background(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
        return SubtractBackground3D.subtractBackground(clij, arg1, arg2, new Double (arg3).floatValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue());
    }
     ...
     * Apply a top-hat filter to the input image.
     */
    public boolean top_hat_box(ClearCLBuffer input, ClearCLBuffer destination, double radiusX, double radiusY, double radiusZ) {
        return TopHatBox.topHatBox(clij, input, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue(), new Double (radiusZ).intValue());
    }
     ...
     * Apply a top-hat filter to the input image.
     */
    public boolean top_hat_sphere(ClearCLBuffer input, ClearCLBuffer destination, double radiusX, double radiusY, double radiusZ) {
        return TopHatSphere.topHatSphere(clij, input, destination, new Double (radiusX).intValue(), new Double (radiusY).intValue(), new Double (radiusZ).intValue());
    }
     ...
     * Takes two images containing coordinates and builds up a matrix containing distance between the points. Convention: image width represents number of points, height represents dimensionality (2D, 3D, ... 10D). The result image has width the first input image and height equals to the width of the second input image.
     */
    public boolean generate_distance_matrix(ClearCLBuffer coordinate_list1, ClearCLBuffer coordinate_list2, ClearCLBuffer distance_matrix_destination) {
        return GenerateDistanceMatrix.generateDistanceMatrix(clij, coordinate_list1, coordinate_list2, distance_matrix_destination);
    }
     ...
     * Determine the shortest distance from a distance matrix. This corresponds to the minimum in a matrix for each individial column.
     */
    public boolean shortest_distances(ClearCLBuffer distance_matrix, ClearCLBuffer destination_minimum_distances) {
        return ShortestDistances.shortestDistances(clij, distance_matrix, destination_minimum_distances);
    }
     ...
     * pixels (with d = dimensionality of the original image) with the coordinates of the maxima.
     */
    public boolean spots_to_point_list(ClearCLBuffer input_spots, ClearCLBuffer destination_pointlist) {
        return SpotsToPointList.spotsToPointList(clij, input_spots, destination_pointlist);
    }
     ...
     * Transpose X and Y in an image.
     */
    public boolean transpose_x_y(ClearCLBuffer input, ClearCLBuffer destination) {
        return TransposeXY.transposeXY(clij, input, destination);
    }
     ...
     * Transpose X and Z in an image.
     */
    public boolean transpose_x_z(ClearCLBuffer input, ClearCLBuffer destination) {
        return TransposeXZ.transposeXZ(clij, input, destination);
    }
     ...
     * Transpose Y and Z in an image.
     */
    public boolean transpose_y_z(ClearCLBuffer input, ClearCLBuffer destination) {
        return TransposeYZ.transposeYZ(clij, input, destination);
    }
     ...
     * 
     */
    public boolean particle_image_velocimetry_2_d(ClearCLImage arg1, ClearCLImage arg2, ClearCLImage arg3, ClearCLImage arg4, double arg5) {
        return FastParticleImageVelocimetry.particleImageVelocimetry2D(clij, arg1, arg2, arg3, arg4, new Double (arg5).intValue());
    }
     ...
     * 
     */
    public boolean particle_image_velocimetry_2_d(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, double arg5) {
        return FastParticleImageVelocimetry.particleImageVelocimetry2D(clij, arg1, arg2, arg3, arg4, new Double (arg5).intValue());
    }
     ...
     * X and Y in the two corresponding destination images.
     */
    public boolean particle_image_velocimetry(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, ClearCLBuffer arg5, double arg6, double arg7, double arg8, boolean arg9) {
        return ParticleImageVelocimetry.particleImageVelocimetry(clij, arg1, arg2, arg3, arg4, arg5, new Double (arg6).intValue(), new Double (arg7).intValue(), new Double (arg8).intValue(), arg9);
    }
     ...
     * Run particle image velocimetry on a 2D+t timelapse.
     */
    public boolean particle_image_velocimetry_timelapse(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, int arg5, int arg6, int arg7, boolean arg8) {
        return ParticleImageVelocimetryTimelapse.particleImageVelocimetryTimelapse(clij, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
     ...
     * Applies particle image velocimetry to two images and registers them afterwards by warping input image 2 with a smoothed vector field.
     */
    public boolean deformable_registration_2_d(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, int arg4, int arg5) {
        return DeformableRegistration2D.deformableRegistration2D(clij, arg1, arg2, arg3, arg4, arg5);
    }
     ...
     * Measures center of mass of thresholded objects in the two input images and translates the second image so that it better fits to the first image.
     */
    public boolean translation_registration(ClearCLBuffer input1, ClearCLBuffer input2, ClearCLBuffer destination) {
        return TranslationRegistration.translationRegistration(clij, input1, input2, destination);
    }
     ...
     * Measures center of mass of thresholded objects in the two input images and translates the second image so that it better fits to the first image.
     */
    public boolean translation_registration(ClearCLBuffer arg1, ClearCLBuffer arg2, double[] arg3) {
        return TranslationRegistration.translationRegistration(clij, arg1, arg2, arg3);
    }
     ...
     * Applies 2D translation registration to every pair of t, t+1 slices of a 2D+t image stack.
     */
    public boolean translation_timelapse_registration(ClearCLBuffer input, ClearCLBuffer output) {
        return TranslationTimelapseRegistration.translationTimelapseRegistration(clij, input, output);
    }
     ...
     * <pre>f(a) = v</pre>
     */
    public boolean set_where_xequals_y(ClearCLImage source, double value) {
        return SetWhereXequalsY.setWhereXequalsY(clij, source, new Double (value).floatValue());
    }
     ...
     * <pre>f(a) = v</pre>
     */
    public boolean set_where_xequals_y(ClearCLBuffer source, double value) {
        return SetWhereXequalsY.setWhereXequalsY(clij, source, new Double (value).floatValue());
    }
     ...
     * Converts an image into a table.
     */
    public ResultsTable image_2_d_to_results_table(ClearCLImage arg1, ResultsTable arg2) {
        return Image2DToResultsTable.image2DToResultsTable(clij, arg1, arg2);
    }
     ...
     * Converts an image into a table.
     */
    public ResultsTable image_2_d_to_results_table(ClearCLBuffer arg1, ResultsTable arg2) {
        return Image2DToResultsTable.image2DToResultsTable(clij, arg1, arg2);
    }
     ...
     * Takes an image with three/four rows (2D: height = 3; 3D: height = 4): x, y [, z] and v and target image. The value v will be written at position x/y[/z] in the target image.
     */
    public boolean write_values_to_positions(ClearCLBuffer positionsAndValues, ClearCLBuffer destination) {
        return WriteValuesToPositions.writeValuesToPositions(clij, positionsAndValues, destination);
    }
     ...
     * Reads out the size of an image [stack] and writes it to the results table in the columns 'Width', 'Height' and 'Depth'.
     */
    public long[] get_size(ClearCLBuffer source) {
        return GetSize.getSize(clij, source);
    }
     ...
     * Multiplies two matrices with each other.
     */
    public boolean multiply_matrix(ClearCLBuffer matrix1, ClearCLBuffer matrix2, ClearCLBuffer matrix_destination) {
        return MultiplyMatrix.multiplyMatrix(clij, matrix1, matrix2, matrix_destination);
    }
     ...
     * The result will be put in the results table as 1 if yes and 0 otherwise.
     */
    public boolean matrix_equal(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
        return MatrixEqual.matrixEqual(clij, arg1, arg2, new Double (arg3).floatValue());
    }
     ...
     * Calculates x to the power of y pixel wise of two images X and Y.
     */
    public boolean power_images(ClearCLBuffer input, ClearCLBuffer exponent, ClearCLBuffer destination) {
        return PowerImages.powerImages(clij, input, exponent, destination);
    }
     ...
     * f(a, b) = 1 if a >= b; 0 otherwise. 
     */
    public boolean greater_or_equal(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
        return GreaterOrEqual.greaterOrEqual(clij, source1, source2, destination);
    }
     ...
     * f(a, b) = 1 if a <= b; 0 otherwise. 
     */
    public boolean smaller_or_equal(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
        return SmallerOrEqual.smallerOrEqual(clij, source1, source2, destination);
    }
     ...
     * f(a, b) = 1 if a != b; 0 otherwise. 
     */
    public boolean not_equal(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
        return NotEqual.notEqual(clij, source1, source2, destination);
    }
     ...
     * Read an image from disc.
     */
    public ClearCLBuffer read_image_from_disc(String arg1) {
        return ReadImageFromDisc.readImageFromDisc(clij, arg1);
    }
     ...
     * Reads a raw file from disc and pushes it immediately to the GPU.
     */
    public boolean read_raw_image_from_disc(ClearCLBuffer arg1, String arg2) {
        return ReadRawImageFromDisc.readRawImageFromDisc(clij, arg1, arg2);
    }
     ...
     * Reads a raw file from disc and pushes it immediately to the GPU.
     */
    public ClearCLBuffer read_raw_image_from_disc(String arg1, double arg2, double arg3, double arg4, double arg5) {
        return ReadRawImageFromDisc.readRawImageFromDisc(clij, arg1, new Double (arg2).intValue(), new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue());
    }
     ...
     *  It is assumed that all images have the same size. If this is not the case, call release(image) before  getting the second image.
     */
    public ClearCLBuffer preload_from_disc(ClearCLBuffer arg1, String arg2, String arg3, String arg4) {
        return PreloadFromDisc.preloadFromDisc(clij, arg1, arg2, arg3, arg4);
    }
     ...
     * f(a, b) = 1 if a == b; 0 otherwise. 
     */
    public boolean equal_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return EqualConstant.equalConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * f(a, b) = 1 if a >= b; 0 otherwise. 
     */
    public boolean greater_or_equal_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return GreaterOrEqualConstant.greaterOrEqualConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * f(a, b) = 1 if a > b; 0 otherwise. 
     */
    public boolean greater_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return GreaterConstant.greaterConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * f(a, b) = 1 if a < b; 0 otherwise. 
     */
    public boolean smaller_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return SmallerConstant.smallerConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * f(a, b) = 1 if a <= b; 0 otherwise. 
     */
    public boolean smaller_or_equal_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return SmallerOrEqualConstant.smallerOrEqualConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * f(a, b) = 1 if a != b; 0 otherwise. 
     */
    public boolean not_equal_constant(ClearCLBuffer source, ClearCLBuffer destination, double constant) {
        return NotEqualConstant.notEqualConstant(clij, source, destination, new Double (constant).floatValue());
    }
     ...
     * Draws a box at a given start point with given size. All pixels other than in the box are untouched. Consider using clij.op.set(buffer, 0); in advance.
     */
    public boolean draw_box(ClearCLBuffer arg1, double arg2, double arg3, double arg4, double arg5) {
        return DrawBox.drawBox(clij, arg1, new Double (arg2).floatValue(), new Double (arg3).floatValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue());
    }
     ...
     * Draws a box at a given start point with given size. All pixels other than in the box are untouched. Consider using clij.op.set(buffer, 0); in advance.
     */
    public boolean draw_box(ClearCLBuffer destination, double x, double y, double z, double width, double height, double depth) {
        return DrawBox.drawBox(clij, destination, new Double (x).floatValue(), new Double (y).floatValue(), new Double (z).floatValue(), new Double (width).floatValue(), new Double (height).floatValue(), new Double (depth).floatValue());
    }
    ...
    public boolean drawLine(ClearCLBuffer destination, double x1, double y1, double z1, double x2, double y2, double z2, double thickness) {
        return DrawLine.drawLine(clij, destination, new Double (x1).floatValue(), new Double (y1).floatValue(), new Double (z1).floatValue(), new Double (x2).floatValue(), new Double (y2).floatValue(), new Double (z2).floatValue(), new Double (thickness).floatValue());
    }

    /**
     * Draws a line between two points with a given thickness. All pixels other than on the line are untouched. Consider using clij.op.set(buffer, 0); in advance.
     */
    public boolean draw_line(ClearCLBuffer destination, double x1, double y1, double z1, double x2, double y2, double z2, double thickness) {
        return DrawLine.drawLine(clij, destination, new Double (x1).floatValue(), new Double (y1).floatValue(), new Double (z1).floatValue(), new Double (x2).floatValue(), new Double (y2).floatValue(), new Double (z2).floatValue(), new Double (thickness).floatValue());
    }
     ...
     * Draws a sphere around a given point with given radii in x, y and z (if 3D). All pixels other than in the sphere are untouched. Consider using clij.op.set(buffer, 0); in advance.
     */
    public boolean draw_sphere(ClearCLBuffer arg1, double arg2, double arg3, double arg4, double arg5) {
        return DrawSphere.drawSphere(clij, arg1, new Double (arg2).floatValue(), new Double (arg3).floatValue(), new Double (arg4).floatValue(), new Double (arg5).floatValue());
    }
     ...
     * Draws a sphere around a given point with given radii in x, y and z (if 3D). All pixels other than in the sphere are untouched. Consider using clij.op.set(buffer, 0); in advance.
     */
    public boolean draw_sphere(ClearCLBuffer destination, double x, double y, double z, double radius_x, double radius_y, double radius_z) {
        return DrawSphere.drawSphere(clij, destination, new Double (x).floatValue(), new Double (y).floatValue(), new Double (z).floatValue(), new Double (radius_x).floatValue(), new Double (radius_y).floatValue(), new Double (radius_z).floatValue());
    }
     ...
     * Replaces a specific intensity in an image with a given new value.
     */
    public boolean replace_intensity(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
        return ReplaceIntensity.replaceIntensity(clij, arg1, arg2, new Double (arg3).floatValue(), new Double (arg4).floatValue());
    }
     ...
     * Results table in the column 'BoundingBoxX', 'BoundingBoxY', 'BoundingBoxZ', 'BoundingBoxWidth', 'BoundingBoxHeight' 'BoundingBoxDepth'.In case of 2D images Z and depth will be zero.
     */
    public double[] bounding_box(ClearCLBuffer source) {
        return BoundingBox.boundingBox(clij, source);
    }
     ...
     * Determines the minimum intensity in an image, but only in pixels which have non-zero values in another mask image.
     */
    public double minimum_of_masked_pixels(ClearCLBuffer source, ClearCLBuffer mask) {
        return MinimumOfMaskedPixels.minimumOfMaskedPixels(clij, source, mask);
    }
     ...
     * Determines the maximum intensity in an image, but only in pixels which have non-zero values in another mask image.
     */
    public double maximum_of_masked_pixels(ClearCLBuffer source, ClearCLBuffer mask) {
        return MaximumOfMaskedPixels.maximumOfMaskedPixels(clij, source, mask);
    }
     ...
     * Determines the mean intensity in an image, but only in pixels which have non-zero values in another binary mask image.
     */
    public double mean_of_masked_pixels(ClearCLBuffer source, ClearCLBuffer mask) {
        return MeanOfMaskedPixels.meanOfMaskedPixels(clij, source, mask);
    }
     ...
     * Masks a single label in a label map: Sets all pixels in the target image to 1, where the given label index was present in the label map.
     */
    public boolean label_to_mask(ClearCLBuffer label_map_source, ClearCLBuffer mask_destination, double label_index) {
        return LabelToMask.labelToMask(clij, label_map_source, mask_destination, new Double (label_index).floatValue());
    }
     ...
     * This corresponds to the n row indices with minimum values for each column of the distance matrix.
     */
    public boolean n_closest_points(ClearCLBuffer arg1, ClearCLBuffer arg2) {
        return NClosestPoints.nClosestPoints(clij, arg1, arg2);
    }
     ...
     * //Symposium on Computer Architecture (ISCA), June 2009.
     */
    public boolean gauss_jordan(ClearCLBuffer A_matrix, ClearCLBuffer B_result_vector, ClearCLBuffer solution_destination) {
        return GaussJordan.gaussJordan(clij, A_matrix, B_result_vector, solution_destination);
    }
     ...
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public double[][] statistics_of_labelled_pixels(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3, int arg4) {
        return StatisticsOfLabelledPixels.statisticsOfLabelledPixels(clij, arg1, arg2, arg3, arg4);
    }
     ...
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public double[] statistics_of_labelled_pixels(ClearCLBuffer arg1, ClearCLBuffer arg2, int arg3) {
        return StatisticsOfLabelledPixels.statisticsOfLabelledPixels(clij, arg1, arg2, arg3);
    }
     ...
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public double[][] statistics_of_labelled_pixels(ClearCLBuffer input, ClearCLBuffer labelmap) {
        return StatisticsOfLabelledPixels.statisticsOfLabelledPixels(clij, input, labelmap);
    }
     ...
     * Determines bounding box, area (in pixels/voxels), min, max and mean intensity  of a labelled object in a label map and corresponding pixels in the original image.Instead of a label map, you can also use a binary image as a binary image is a label map with just one label.
     */
    public ResultsTable statistics_of_labelled_pixels(ClearCLBuffer arg1, ClearCLBuffer arg2, ResultsTable arg3) {
        return StatisticsOfLabelledPixels.statisticsOfLabelledPixels(clij, arg1, arg2, arg3);
    }
     ...
     * Results table in the column 'Variance'.
     */
    public double variance_of_all_pixels(ClearCLBuffer arg1, double arg2) {
        return VarianceOfAllPixels.varianceOfAllPixels(clij, arg1, new Double (arg2).floatValue());
    }
     ...
     * Results table in the column 'Variance'.
     */
    public double variance_of_all_pixels(ClearCLBuffer source) {
        return VarianceOfAllPixels.varianceOfAllPixels(clij, source);
    }
     ...
     * Results table in the column 'Standard_deviation'.
     */
    public double standard_deviation_of_all_pixels(ClearCLBuffer arg1, double arg2) {
        return StandardDeviationOfAllPixels.standardDeviationOfAllPixels(clij, arg1, new Double (arg2).floatValue());
    }
     ...
     * Results table in the column 'Standard_deviation'.
     */
    public double standard_deviation_of_all_pixels(ClearCLBuffer source) {
        return StandardDeviationOfAllPixels.standardDeviationOfAllPixels(clij, source);
    }
     ...
     * Removes all labels from a label map which touch the edges. Remaining label elements are renumbered afterwards.
     */
    public boolean exclude_labels_on_edges(ClearCLBuffer label_map_input, ClearCLBuffer label_map_destination) {
        return ExcludeLabelsOnEdges.excludeLabelsOnEdges(clij, label_map_input, label_map_destination);
    }
     ...
     * Subtracts one binary image from another.
     */
    public boolean binary_subtract(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return BinarySubtract.binarySubtract(clijx, arg1, arg2, arg3);
    }
     ...
     * Determines pixels/voxels which are on the surface of a binary objects and sets only them to 1 in the destination image.
     */
    public boolean binary_edge_detection(ClearCLImageInterface arg1, ClearCLImageInterface arg2) {
        return BinaryEdgeDetection.binaryEdgeDetection(clijx, arg1, arg2);
    }
     ...
     * 
     */
    public boolean local_positive_minimum(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return DistanceMap.localPositiveMinimum(clijx, arg1, arg2, arg3);
    }
     ...
     * Generates a distance map from a binary image.
     */
    public boolean distance_map(ClearCLBuffer source, ClearCLBuffer destination) {
        return DistanceMap.distanceMap(clijx, source, destination);
    }
     ...
     * Pulls a binary image from the GPU memory and puts it on the currently active ImageJ window.
     */
    public Roi pull_as_r_o_i(ClearCLBuffer binary_input) {
        return PullAsROI.pullAsROI(clij, binary_input);
    }
     ...
     * Apply a maximum-sphere filter to the input image. The radius is fixed to 1 and pixels with value 0 are ignored.
     */
    public ClearCLKernel nonzero_maximum_diamond(ClearCLImageInterface arg1, ClearCLBuffer arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
        return NonzeroMaximumDiamond.nonzeroMaximumDiamond(clijx, arg1, arg2, arg3, arg4);
    }
     ...
     * Apply a maximum-sphere filter to the input image. The radius is fixed to 1 and pixels with value 0 are ignored.
     */
    public boolean nonzero_maximum_diamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return NonzeroMaximumDiamond.nonzeroMaximumDiamond(clij, arg1, arg2, arg3);
    }
     ...
     * TODO
     */
    public boolean onlyzero_overwrite_maximum_diamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return OnlyzeroOverwriteMaximumDiamond.onlyzeroOverwriteMaximumDiamond(clij, arg1, arg2, arg3);
    }
     ...
     * 
     */
    public boolean onlyzero_overwrite_maximum_box(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
        return OnlyzeroOverwriteMaximumBox.onlyzeroOverwriteMaximumBox(clij, arg1, arg2, arg3);
    }
     ...
     * Takes a labelmap with n labels and generates a (n+1)*(n+1) matrix where all pixels are set to 0 exept those where labels are touching.Only half of the matrix is filled (with x < y). For example, if labels 3 and 4 are touching then the pixel (3,4) in the matrix will be set to 1.
     */
    public boolean generate_touch_matrix(ClearCLBuffer label_map, ClearCLBuffer touch_matrix_destination) {
        return GenerateTouchMatrix.generateTouchMatrix(clij, label_map, touch_matrix_destination);
    }
     ...
     * Takes a labelmap with n labels and generates a (n+1)*(n+1) matrix where all pixels are set to 0 exept those where labels are touching.Only half of the matrix is filled (with x < y). For example, if labels 3 and 4 are touching then the pixel (3,4) in the matrix will be set to 1.
     */
    public boolean detect_label_edges(ClearCLBuffer label_map, ClearCLBuffer touch_matrix_destination) {
        return DetectLabelEdges.detectLabelEdges(clijx, label_map, touch_matrix_destination);
    }

}
// 339 methods generated.
