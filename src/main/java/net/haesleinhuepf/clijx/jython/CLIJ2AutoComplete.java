...
class CLIJ2AutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.blur2D(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigmaX, Float sigmaY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.blur3D(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigmaX, Float sigmaY, Float sigmaZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.blur(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigmaX, Float sigmaY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.closeIndexGapsInLabelMap(ClearCLBuffer binary_input, ClearCLImageInterface labeling_destination)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.distanceMatrixToMesh(ClearCLBuffer pointlist, ClearCLBuffer distance_matrix, ClearCLBuffer mesh_destination, Float maximumDistance)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.flip2D(ClearCLImageInterface source, ClearCLImageInterface destination, Boolean flipX, Boolean flipY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.flip3D(ClearCLImageInterface source, ClearCLImageInterface destination, Boolean flipX, Boolean flipY, Boolean flipZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.gaussianBlur3D(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigmaX, Float sigmaY, Float sigmaZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maskStackWithPlane(ClearCLImageInterface source_3d, ClearCLImageInterface mask_2d, ClearCLImageInterface destination_3d)";
       description = "<b>maskStackWithPlane</b><br><br>Computes a masked image by applying a 2D mask to an image stack. All pixel values x of image X will be copied<br>to the destination image in case pixel value m at the same spatial position in the mask image is not equal to <br>zero.<br><br><pre>f(x,m) = (x if (m != 0); (0 otherwise))</pre><br><br>Parameters:<br>ClearCLImageInterface source_3d, ClearCLImageInterface mask_2d, ClearCLImageInterface destination_3d";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximum2DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximum2DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximum3DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximum3DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximumBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.maximumZProjectionBounded(ClearCLBuffer source, ClearCLBuffer destination_max, Integer min_z, Integer max_z)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.mean2DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.mean2DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.mean3DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       description = "<b>mean3DBox</b><br><br>Computes the local mean average of a pixels cube neighborhood. The cubes size is specified by <br>its half-width, half-height and half-depth (radius).<br><br>Parameters:<br>ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.mean3DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.meanZProjectionBounded(ClearCLBuffer source, ClearCLBuffer destination_mean, Integer min_z, Integer max_z)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimum2DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimum2DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimum3DBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimum3DSphere(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ)";
       description = "<b>minimum3DSphere</b><br><br>Computes the local minimum of a pixels spherical neighborhood. The spheres size is specified by <br>its half-width, half-height and half-depth (radius).<br><br>Parameters:<br>ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY, Integer radiusZ";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimumBox(ClearCLImageInterface source, ClearCLImageInterface destination, Integer radiusX, Integer radiusY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimumZProjectionBounded(ClearCLBuffer source, ClearCLBuffer destination_min, Integer min_z, Integer max_z)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination_sum)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.paste2D(ClearCLImageInterface source, ClearCLImageInterface destination, Integer destinationX, Integer destinationY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.paste3D(ClearCLImageInterface source, ClearCLImageInterface destination, Integer destinationX, Integer destinationY, Integer destinationZ)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.paste(ClearCLImageInterface source, ClearCLImageInterface destination, Integer destinationX, Integer destinationY)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.replaceIntensity(ClearCLImageInterface input, ClearCLImageInterface destination, Float oldValue, Float newValue)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.resample(ClearCLImageInterface source, ClearCLImageInterface destination, Float factorX, Float factorY, Float factorZ, Boolean linearInterpolation)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.threshold(ClearCLBuffer source, ClearCLBuffer destination, Float threshold)";
