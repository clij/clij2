...
class CLIJxAutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.convolveWithSobel(ClearCLBuffer arg1, ClearCLBuffer arg2)";
       description = "<b>convolveWithSobel</b><br><br>null";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>equalizeMeanIntensitiesOfSlices</b><br><br>Determines correction factors for each slice so that the average intensity in all slices can be made the same and applies the factors.<br>This functionality is similar to the 'Simple Ratio Bleaching Correction' in Fiji.<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2, Integer arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>touchMatrixToMesh</b><br><br>Takes a pointlist with dimensions n*d with n point coordinates in d dimensions and a touch matrix of size n*n. and draws lines from all points to points if the corresponding pixel in the touch matrix is 1.<br><br>Parameters:<br>ClearCLBuffer pointlist, ClearCLBuffer touch_matrix, ClearCLBuffer mesh_destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.watershed(ClearCLBuffer source, ClearCLBuffer destination)";
       description = "<b>watershed</b><br><br>Detects local maxima regions. Pixels in the resulting image are set to 1 if<br>there is no other pixel in a given radius which has a higher intensity, and to 0 otherwise.<br><br>Parameters:<br>ClearCLBuffer source, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
