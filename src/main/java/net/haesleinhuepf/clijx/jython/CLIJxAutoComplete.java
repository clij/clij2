...
class CLIJxAutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.projectMinimumThresholdedZBounded(ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3, Integer arg4, Integer arg5)";
       description = "<b>projectMinimumThresholdedZBounded</b><br><br>Determines the minimum projection of all pixels in an image above a given threshold along Z within a given z range.<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3, Integer arg4, Integer arg5";
       list.add(new BasicCompletion(provider, headline, null, description));
