 ...
 *
 * To reduce dependencies towards ImageJ1
 *
 */
    ...
    /** Autothresholding methods (limited to 256 bin histograms) from the Auto_Threshold plugin
     (http://fiji.sc/Auto_Threshold) by G.Landini at bham dot ac dot uk). */
        ...
        public static String[] getMethods() {
            if (mStrings==null) {
                ij.process.AutoThresholder.Method[] mVals = ij.process.AutoThresholder.Method.values();
        ...
        public int getThreshold(ij.process.AutoThresholder.Method method, int[] histogram) {
            if (histogram==null)
        ...
        public int getThreshold(String mString, int[] histogram) {
            ...
            ij.process.AutoThresholder.Method method = ij.process.AutoThresholder.Method.valueOf(ij.process.AutoThresholder.Method.class, mString);
