 ...
 * 12 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_medianSliceBySliceBox")
public class MedianSliceBySliceBox extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {

    @Override
    public boolean executeCL() {
        return median3DSliceBySliceBox(getCLIJx(), (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), asInteger(args[2]), asInteger(args[3]));
    }

    public static boolean median3DSliceBySliceBox(CLIJx clijx, ClearCLImageInterface src, ClearCLImageInterface dst, Integer radiusX, Integer radiusY) {
        ...
        clijx.execute(MedianSliceBySliceBox.class, "median_slice_by_slice_box_3d_x.cl", "median_slice_by_slice_box_3d", dst.getDimensions(), dst.getDimensions(), parameters);
        return true;
    }
