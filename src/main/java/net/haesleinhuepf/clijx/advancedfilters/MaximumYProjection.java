...
public class MaximumYProjection extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public static boolean maximumYProjection(CLIJx clijx, ClearCLBuffer src, ClearCLBuffer dst_max) {
        ...
        clijx.execute(MaximumYProjection.class, "maximum_y_projection_" + src.getDimension() + "d_" + dst_max.getDimension() + "d_x.cl", "maximum_y_projection_" + src.getDimension() + "d_" + dst_max.getDimension() + "d", dst_max.getDimensions(), dst_max.getDimensions(), parameters);
        return true;
    }
