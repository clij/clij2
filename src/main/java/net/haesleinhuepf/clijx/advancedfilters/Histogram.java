 ...
 *         December 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_histogram")
public class Histogram extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, HasLicense, HasAuthor {
    ...
    public static boolean histogram(CLIJx clijx, ClearCLBuffer src, ClearCLBuffer histogram) {
        return histogram(clijx, src, histogram, 256, 0f, 0f, true);
    }

    public static ClearCLBuffer histogram(CLIJx clijx, ClearCLBuffer src) {
        ClearCLBuffer histogram = clijx.create(new long[]{256, 1, 1}, clijx.Float);
        histogram(clijx, src, histogram, (int)histogram.getWidth(), 0f, 0f, true);
        return histogram;
    }

    public static boolean histogram(CLIJx clijx, ClearCLBuffer src, ClearCLBuffer histogram, Integer numberOfBins, Float minimumGreyValue, Float maximumGreyValue, Boolean determineMinMax) {
        return histogram(clijx, src, histogram, numberOfBins, minimumGreyValue, maximumGreyValue, determineMinMax, false);
    }

    public static boolean histogram(CLIJx clijx, ClearCLBuffer src, ClearCLBuffer histogram, Integer numberOfBins, Float minimumGreyValue, Float maximumGreyValue, Boolean determineMinMax, boolean showTable) {
        ...
        // determine histogram
        boolean result = fillHistogram(clijx, src, histogram, minimumGreyValue, maximumGreyValue);
     ...
     */
    @Deprecated
    public static boolean fillHistogram(CLIJx clijx, ClearCLBuffer src, ClearCLBuffer dstHistogram, Float minimumGreyValue, Float maximumGreyValue) {
        ...
        ClearCLBuffer  partialHistograms = clijx.create(histogramBufferSize, dstHistogram.getNativeType());
