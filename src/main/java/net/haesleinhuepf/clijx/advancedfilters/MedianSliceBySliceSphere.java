 ...
 * 12 2018
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_medianSliceBySliceSphere")
public class MedianSliceBySliceSphere extends AbstractCLIJxPlugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public boolean executeCL() {
        ...
        return median3DSliceBySliceSphere(getCLIJx(), (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), radiusX, radiusY);
    }

    public static boolean median3DSliceBySliceSphere(CLIJx clijx, ClearCLImageInterface src, ClearCLImageInterface dst, Integer radiusX, Integer radiusY) {
        ...
        clijx.execute(MedianSliceBySliceSphere.class, "median_slice_by_slice_sphere_3d_x.cl", "median_slice_by_slice_sphere_3d", dst.getDimensions(), dst.getDimensions(), parameters);
        return true;
    }
