...
public class CLIJ1MinimumSliceBySliceSphere{
     ...
     */
    public boolean minimumSliceBySliceSphere(CLIJ clij, ClearCLBuffer source, ClearCLBuffer destination, double radiusX, double radiusY) {
