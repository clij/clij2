...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_centroidsOfLabels")
public class CentroidsOfLabels extends net.haesleinhuepf.clij2.plugins.CentroidsOfLabels {
}
