...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_thresholdMinError")
public class ThresholdMinError extends net.haesleinhuepf.clij2.plugins.ThresholdMinError {
}
