...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_thresholdTriangle")
public class ThresholdTriangle extends net.haesleinhuepf.clij2.plugins.ThresholdTriangle {
}
