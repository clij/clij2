...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_thresholdShanbhag")
public class ThresholdShanbhag extends net.haesleinhuepf.clij2.plugins.ThresholdShanbhag {
}
