...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_nonzeroMinimumBox")
public class NonzeroMinimumBox extends net.haesleinhuepf.clij2.plugins.NonzeroMinimumBox {
}
