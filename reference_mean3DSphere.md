...
```
Ext.CLIJx_mean3DSphere(Image source, Image destination, Number radiusX, Number radiusY, Number radiusZ);
```
...
clij2.mean3DSphere(clij, source, destination, radiusX, radiusY, radiusZ);
```
